...
const steps = [
  {
    ...
    description: 'Нажмите кнопку «Скачать» ниже и сохраните файл installer.desktop на ваш компьютер.'
  },
  {
    title: 'Разрешите запуск файла',
    description: 'При необходимости разрешите выполнение скачанного файла в настройках безопасности системы.'
  },
  {
    title: 'Запустите установку',
    description: 'Откройте скачанный файл и следуйте подсказкам мастера установки.'
  },
  {
    title: 'Войдите в приложение',
    description: 'После установки запустите программу и войдите, используя ваши учётные данные.'
  }
]
